...
/* Charging Current Setting */ // DONT UP THIS SETTINGS!!! USB input block was gave you terible smell (info ONLY FOR DOOGEE X5 MAX PRO)
#define USB_CHARGER_CURRENT_SUSPEND			0
#define USB_CHARGER_CURRENT_UNCONFIGURED	CHARGE_CURRENT_70_00_MA
#define USB_CHARGER_CURRENT_CONFIGURED		CHARGE_CURRENT_500_00_MA // DONT UP THIS MORE THEN 500_00_MA for doogee

#define USB_CHARGER_CURRENT					CHARGE_CURRENT_500_00_MA
#define AC_CHARGER_CURRENT					CHARGE_CURRENT_900_00_MA // DONT UP THIS MORE THEN 900_00_MA for doogee
